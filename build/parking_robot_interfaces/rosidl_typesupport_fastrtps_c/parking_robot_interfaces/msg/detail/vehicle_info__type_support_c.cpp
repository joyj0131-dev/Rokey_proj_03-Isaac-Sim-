...
#include "parking_robot_interfaces/msg/detail/vehicle_info__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleInfo__ros_msg_type = parking_robot_interfaces__msg__VehicleInfo;
...
static uint32_t _VehicleInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_parking_robot_interfaces__msg__VehicleInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = parking_robot_interfaces__msg__VehicleInfo;
    is_plain =
      (
...
static size_t _VehicleInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_parking_robot_interfaces__msg__VehicleInfo(
