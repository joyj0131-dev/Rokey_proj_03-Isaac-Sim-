...
#include "parking_robot_interfaces/msg/detail/formation_stop__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // reason, source_robot_id, task_id
#include "rosidl_runtime_c/string_functions.h"  // reason, source_robot_id, task_id

// forward declare type support functions


using _FormationStop__ros_msg_type = parking_robot_interfaces__msg__FormationStop;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _FormationStop__ros_msg_type * ros_message = static_cast<const _FormationStop__ros_msg_type *>(untyped_ros_message);
  // Field name: task_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _FormationStop__ros_msg_type * ros_message = static_cast<_FormationStop__ros_msg_type *>(untyped_ros_message);
  // Field name: task_id
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_parking_robot_interfaces__msg__FormationStop(
  const void * untyped_ros_message,
...
static uint32_t _FormationStop__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_parking_robot_interfaces__msg__FormationStop(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_parking_robot_interfaces
size_t max_serialized_size_parking_robot_interfaces__msg__FormationStop(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = parking_robot_interfaces__msg__FormationStop;
    is_plain =
      (
...
static size_t _FormationStop__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_parking_robot_interfaces__msg__FormationStop(
...
static message_type_support_callbacks_t __callbacks_FormationStop = {
...
static rosidl_message_type_support_t _FormationStop__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FormationStop,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, parking_robot_interfaces, msg, FormationStop)() {
  return &_FormationStop__type_support;
}
