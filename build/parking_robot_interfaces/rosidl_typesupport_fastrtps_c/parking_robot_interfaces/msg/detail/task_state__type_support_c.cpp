...
#include "parking_robot_interfaces/msg/detail/task_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // current_step, robot_id, state, task_id
#include "rosidl_runtime_c/string_functions.h"  // current_step, robot_id, state, task_id

// forward declare type support functions


using _TaskState__ros_msg_type = parking_robot_interfaces__msg__TaskState;
...
static uint32_t _TaskState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_parking_robot_interfaces__msg__TaskState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = parking_robot_interfaces__msg__TaskState;
    is_plain =
      (
...
static size_t _TaskState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_parking_robot_interfaces__msg__TaskState(
