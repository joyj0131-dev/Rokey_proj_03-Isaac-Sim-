...
bool parking_robot_interfaces__msg__formation_stop__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("parking_robot_interfaces.msg._formation_stop.FormationStop", full_classname_dest, 58) == 0);
  }
  parking_robot_interfaces__msg__FormationStop * ros_message = _ros_message;
  {  // task_id
...
{
  /* NOTE(esteve): Call constructor of FormationStop */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("parking_robot_interfaces.msg._formation_stop");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FormationStop");
