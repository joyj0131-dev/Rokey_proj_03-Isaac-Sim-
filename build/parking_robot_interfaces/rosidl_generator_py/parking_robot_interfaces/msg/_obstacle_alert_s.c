...
bool parking_robot_interfaces__msg__obstacle_alert__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("parking_robot_interfaces.msg._obstacle_alert.ObstacleAlert", full_classname_dest, 58) == 0);
  }
  parking_robot_interfaces__msg__ObstacleAlert * ros_message = _ros_message;
  {  // obstacle_detected
...
{
  /* NOTE(esteve): Call constructor of ObstacleAlert */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("parking_robot_interfaces.msg._obstacle_alert");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObstacleAlert");
