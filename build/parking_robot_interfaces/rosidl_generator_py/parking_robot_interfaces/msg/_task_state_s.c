...
bool parking_robot_interfaces__msg__task_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("parking_robot_interfaces.msg._task_state.TaskState", full_classname_dest, 50) == 0);
  }
  parking_robot_interfaces__msg__TaskState * ros_message = _ros_message;
  {  // robot_id
...
PyObject * parking_robot_interfaces__msg__task_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("parking_robot_interfaces.msg._task_state");
