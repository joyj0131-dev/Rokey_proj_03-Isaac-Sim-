...
#include "parking_robot_interfaces/msg/detail/task_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = parking_robot_interfaces::msg::TaskState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const parking_robot_interfaces::msg::TaskState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<parking_robot_interfaces::msg::TaskState *>(
    untyped_ros_message);
...
{
  return &parking_robot_interfaces::msg::typesupport_fastrtps_cpp::_TaskState__handle;
}
