...
#ifndef PARKING_ROBOT_INTERFACES__SRV__DETAIL__PARK_IN_SLOT__FUNCTIONS_H_
#define PARKING_ROBOT_INTERFACES__SRV__DETAIL__PARK_IN_SLOT__FUNCTIONS_H_
...
/// Initialize srv/ParkInSlot message.
/**
...
/// Finalize srv/ParkInSlot message.
/**
...
/// Create srv/ParkInSlot message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * parking_robot_interfaces__srv__ParkInSlot_Request__init().
...
/// Destroy srv/ParkInSlot message.
/**
 * It calls
 * parking_robot_interfaces__srv__ParkInSlot_Request__fini()
...
/// Check for srv/ParkInSlot message equality.
/**
...
/// Initialize array of srv/ParkInSlot messages.
/**
...
/// Finalize array of srv/ParkInSlot messages.
/**
 * It calls
 * parking_robot_interfaces__srv__ParkInSlot_Request__fini()
...
/// Create array of srv/ParkInSlot messages.
/**
 * It allocates the memory for the array and calls
 * parking_robot_interfaces__srv__ParkInSlot_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ParkInSlot messages.
/**
 * It calls
 * parking_robot_interfaces__srv__ParkInSlot_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ParkInSlot message array equality.
/**
...
/// Copy an array of srv/ParkInSlot messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * parking_robot_interfaces__srv__ParkInSlot_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_parking_robot_interfaces
...
/**
 * It calls
 * parking_robot_interfaces__srv__ParkInSlot_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_parking_robot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * parking_robot_interfaces__srv__ParkInSlot_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_parking_robot_interfaces
...
/**
 * It calls
 * parking_robot_interfaces__srv__ParkInSlot_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PARKING_ROBOT_INTERFACES__SRV__DETAIL__PARK_IN_SLOT__FUNCTIONS_H_
