...
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('A1', 'entry_a1', 6.875, 'ZIN_A1_dock') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
...
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('A2', 'entry_a2', 6.875, 'ZIN_A2_dock') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
...
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('A3', 'entry_a3', 6.875, 'ZIN_A3_dock') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
...
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('crossing_exit', 'exit_a1', 5.3, 'ZOUT_A1') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('A1', 'exit_a1', 6.875, 'ZOUT_A1_dock') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('crossing_exit', 'exit_a2', 8.7, 'ZOUT_A2') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('A2', 'exit_a2', 6.875, 'ZOUT_A2_dock') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('crossing_exit', 'exit_a3', 12.1, 'ZOUT_A3') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
INSERT INTO parking_lot_edges (u, v, dist_m, zone_id) VALUES ('A3', 'exit_a3', 6.875, 'ZOUT_A3_dock') ON DUPLICATE KEY UPDATE dist_m = VALUES(dist_m), zone_id = VALUES(zone_id);
