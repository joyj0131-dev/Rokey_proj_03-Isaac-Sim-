...
INSTALLED_ROBOT_USD = Path(
    "/home/rokey/Isaac_envo/hwia_parking_robot_final_caster_package/"
    "hwia_parking_robot_final_caster.usd"
)
ROBOT_USD = LOCAL_ROBOT_USD if LOCAL_ROBOT_USD.is_file() else INSTALLED_ROBOT_USD
